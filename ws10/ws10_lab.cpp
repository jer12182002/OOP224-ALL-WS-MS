...
int main() {
    ...
    (violentCrimeStart > violentCrimeEnd) ? trend = "up" : trend = "down";
    ...
    cout << "There are ";
    cout << fixed << setprecision(2) << gtaMillions / 1.0E6;
    cout <<
            gtaMillions
    ...
    // your code goes here
    cout << "The Minimum Violent Crime rate was " <<fixed<<setprecision(2) <<(double) min(violentCrimeRate, N) << endl;
    cout << "The Maximum Violent Crime rate was " <<fixed<<setprecision(2) <<(double) max(violentCrimeRate, N) << endl;
