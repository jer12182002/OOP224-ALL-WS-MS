...
void apply_damage (SuperHero& A, SuperHero& B)
{
   ...
   if(A.m_health>=0&&B.m_health>=0) {
  	A.m_health=A.m_health+A.m_superPowerDefend-B.m_superPowerAttack;
	B.m_health=B.m_health+B.m_superPowerDefend-A.m_superPowerAttack;
   	   //	A.m_superPowerDefend -= B.m_superPowerDefend;
   	//	B.m_superPowerDefend -= A.m_superPowerDefend;
